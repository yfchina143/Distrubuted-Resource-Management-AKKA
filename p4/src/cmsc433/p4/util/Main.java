...
public class Main {
	...
	private static ArrayList<NodeSpecification> setupTest1 () throws FileNotFoundException {
		...
		// Create user scripts
		UserScript script1 = UserScript.fromFile("C:\\Users\\yufan\\Desktop\\cmsc433\\p4\\p4\\test1script1.txt");
		UserScript script2 = UserScript.fromFile("C:\\Users\\yufan\\Desktop\\cmsc433\\p4\\p4\\test1script2.txt");
	...
	private static ArrayList<NodeSpecification> setupTest2 () throws FileNotFoundException {
		...
		ArrayList<UserScript> scriptList1 = new ArrayList<UserScript> ();
		scriptList1.add(UserScript.fromFile("C:\\Users\\yufan\\Desktop\\cmsc433\\p4\\p4\\test2script.txt"));
		NodeSpecification node1 = new NodeSpecification(printers, scriptList1);
	...
	private static ArrayList<NodeSpecification> setupTest3 () throws FileNotFoundException {
		...
		ArrayList<UserScript> scriptList1 = new ArrayList<UserScript> ();
		scriptList1.add(UserScript.fromFile("C:\\Users\\yufan\\Desktop\\cmsc433\\p4\\p4\\test3script1.txt"));
		
		ArrayList<UserScript> scriptList2 = new ArrayList<UserScript> ();
		scriptList2.add(UserScript.fromFile("C:\\Users\\yufan\\Desktop\\cmsc433\\p4\\p4\\test3script2.txt"));
